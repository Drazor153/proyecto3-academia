...
function LevelOptions({ state, dispatch, data }: OptionsProps) {
  ...
  return (
    <Select
      ...
      value={
        levelOptionsFiltered?.find(selected => selected.value == state.level) ??
        null
      }
...
function SemesterOptions({ state, dispatch, data }: OptionsProps) {
  ...
  return (
    <Select
      ...
      value={
        semesterOptionsFiltered?.find(
          selected => selected.value == state.semester,
        ) ?? null
      }
...
function YearOptions({ dispatch, data }: OptionsProps) {
